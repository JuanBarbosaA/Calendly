...
export default function HowItWorksSteps() {
  ...
  useEffect(() => {
    const checkMobile = () => {
      ...
      // Iniciar intervalo solo en escritorio
      if (!mobile && !intervalRef.current) {
  ...
  const startAutoAdvance = (fromIndex = 0) => {
    ...
    // Solo establecer intervalo en escritorio
    if (!isMobile) {
  ...
  const handleClick = (index) => {
    // En móvil solo cambia el paso sin reiniciar intervalo
    if (isMobile) {
          ...
          {steps.map((step, index) => {
            ...
            return (
              ...
              >
                ...
                <div className={styles.containerSvgMobile}>
                  <div className={styles.wrapperSvgMobile}>
                    <svg
                      width="650"
                      height="650"
                      viewBox="0 0 650 650"
                    ...
                    <div className={styles.containerMobileImage} title="Connect your calendars">
                      <img
                        data-testid="image"
                        ...
                        decoding="async"
                        data-nimg="1"
                        src="https://images.ctfassets.net/k0lk9kiuza3o/4NxN65mDr8P3MkFqaaKE2W/39053e1843ca1e63b6ecf86b6bd50a02/connect-your-calendars.png?w=1300&amp;q=85&amp;fm=webp"
                      />
                    </div>
                  </div>
                </div>
